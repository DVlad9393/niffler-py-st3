...
class CurrencyResponse(Message):
    ...
    def ClearField(
        self, field_name: Literal["allCurrencies", b"allCurrencies"]
    ) -> None: ...
...
class Currency(Message):
    ...
    @overload
    def WhichOneof(
        self, oneof_group: Literal["_currency", b"_currency"]
    ) -> Literal["currency"] | None: ...
    @overload
    def WhichOneof(
        self, oneof_group: Literal["_currencyRate", b"_currencyRate"]
    ) -> Literal["currencyRate"] | None: ...
...
class CalculateRequest(Message):
    ...
    @overload
    def WhichOneof(
        self, oneof_group: Literal["_amount", b"_amount"]
    ) -> Literal["amount"] | None: ...
    @overload
    def WhichOneof(
        self, oneof_group: Literal["_desiredCurrency", b"_desiredCurrency"]
    ) -> Literal["desiredCurrency"] | None: ...
    @overload
    def WhichOneof(
        self, oneof_group: Literal["_spendCurrency", b"_spendCurrency"]
    ) -> Literal["spendCurrency"] | None: ...
...
class CalculateResponse(Message):
    ...
    def WhichOneof(
        self, oneof_group: Literal["_calculatedAmount", b"_calculatedAmount"]
    ) -> Literal["calculatedAmount"] | None: ...
