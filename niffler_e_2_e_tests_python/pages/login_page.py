...
class LoginPage(BasePage):
    def __init__(self, page: Page) -> None:
        ...
        self.login_title = Title(page, locator='h1[class="header"]', name="Login title")
        ...
        self.info_have_an_account_text = Text(
            page,
            locator='p[class="header__additional"]',
            name="Info have an account text",
        )
        self.log_in_button = Link(
            page,
            locator='p[class="header__additional"] a[class="form__link"]',
            name="Log in link",
        )
        ...
        self.sign_in_link = Link(
            page,
            locator='a[href="http://frontend.niffler.dc/main"]',
            name="Sign up link",
        )
        ...
        self.input_password_text = Text(
            page, locator='div[contenteditable="plaintext-only"]', name="Input password"
        )

        self.input_password_hide_text_image = Image(
            page,
            locator='button[class="form__password-button form__password-button_active"][id="passwordBtn"]',
            name="Input password hide text image",
        )
        self.input_password_show_text_image = Image(
            page,
            locator='button[class="form__password-button"][id="passwordBtn"]',
            name="Input password show text image",
        )

        self.input_submit_password_hide_text_image = Image(
            page,
            locator='button[class="form__password-button"][id="passwordSubmitBtn"]',
            name="Input password hide text image",
        )
        self.input_submit_password_show_text_image = Image(
            page,
            locator='button[class="form__password-button form__password-button_active"][id="passwordSubmitBtn"]',
            name="Input password show text image",
        )
        self.input_submit_password = Input(
            page,
            locator='input[placeholder="Submit your password"]',
            name="Input password",
        )
        self.congratulations_register_text = Text(
            page,
            locator='//p[contains(text(), "Congratulations!")]',
            name="Congratulations register text",
        )
