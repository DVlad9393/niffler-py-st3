...
class MainPage(BasePage):
    def __init__(self, page: Page) -> None:
        ...
        self.history_of_spending_title = Title(
            page,
            locator='//h2[contains(text(), "History of Spendings")]',
            name="Login title",
        )
        self.no_spending_text = Text(
            page,
            locator='//p[contains(text(), "There are no spendings")]',
            name="No spendings text",
        )
        self.niffler_image = Image(
            page,
            locator='img[src="/assets/niffler-with-a-coin-Cb77k8MX.png"]',
            name="Niffler image",
        )

        self.statistics_block = Block(
            page, locator='//div[@id="stat"]', name="Statistics block"
        )
        self.statistics_title = Title(page, locator="#stat h2", name="Statistics title")
        ...
        self.search_input = Input(
            page, locator='//input[@placeholder="Search"]', name="Search input"
        )
        self.search_button = Button(
            page, locator='button[type="submit"]', name="Search button"
        )
        self.search_button_icon = Image(
            page, locator='button[type="submit"] svg', name="Search button icon"
        )
        self.delete_button = Button(
            page, locator='button[id="delete"]', name="Delete button"
        )
        self.delete_button_dialog = Button(
            page,
            locator='div[role="dialog"] button:has-text("Delete")',
            name="Delete button",
        )
        self.list_of_times = ListItem(
            page, locator='//div[contains(text(), "All time")]', name="List of times"
        )
        self.list_of_currencies = ListItem(
            page,
            locator='//div//span[contains(text(), "ALL")]',
        ...
        self.select_all_checkbox = СheckBox(
            page,
            locator='thead input[type="checkbox"][aria-label="select all rows"]',
        ...
        self.date_header = Text(page, locator='th:has-text("Date")', name="Date header")
        ...
        self.first_row_checkbox = СheckBox(
            page,
            locator='tbody tr td input[type="checkbox"]',
            name="First row checkbox",
            index=0,
        )
        ...
        self.first_row_edit_button = Button(
            page,
            locator='tbody tr td button[aria-label="Edit spending"]',
            name="Edit button in first row",
        )
